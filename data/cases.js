...
window.CASES = [
  ...
  { n: 3,  title: "+3 cases",                     cat: "special", icon: "⏩", short: "Avance de 3 cases", desc: "Tu avances immédiatement de 3 cases (l'effet de la case d'arrivée s'applique)." },
  ...
  { n: 12, title: "Verre d'eau",                  cat: "water",   icon: "💧", short: "Pause hydratation", desc: "Bois un verre d'eau entier. Ton foie te dit merci." },
  ...
  { n: 27, title: "Verre d'eau",                  cat: "water",   icon: "💧", short: "Pause hydratation", desc: "Encore un verre d'eau. Courage." },
  ...
  { n: 47, title: "10 tours sur toi",             cat: "action",  icon: "🌀", short: "Vertige", desc: "10 tours sur toi-même. Si tu tombes, 3 gorgées." },
  { n: 48, title: "10 tours sur toi",             cat: "action",  icon: "🌀", short: "Encore", desc: "10 tours sur toi-même. Oui, encore une fois." },
  { n: 49, title: "Donne 5",                      cat: "give",    icon: "👉", short: "Distribue 5 gorgées", desc: "Répartis 5 gorgées entre les autres." },
  ...
  { n: 52, title: "Eau pour tous",                cat: "water",   icon: "💧", short: "Tout le monde boit de l'eau", desc: "Pause collective. Tout le monde prend un verre d'eau." },
  ...
  { n: 55, title: "Autoroute",                    cat: "action",  icon: "🛣️", short: "Solo", desc: "Lance une autoroute (le jeu d'alcool) en solo contre le temps." },
  ...
  { n: 60, title: "Arrivée",                      cat: "finish",  icon: "🏆", short: "GlouGlou Champion", desc: "Tu as survécu. Tout le monde te fait un toast, et toi tu bois cul sec une dernière fois." },
];
